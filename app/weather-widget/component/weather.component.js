...
var WeatherComponent = (function () {
    ...
    WeatherComponent.prototype.getCurrentWeather = function () {
        ...
        this.service.getCurrentWeather(this.pos.coords.latitude, this.pos.coords.longitude)
            ...
            console.log("Weather: ", _this.weatherData); //TODO: Remove after testing
            _this.setIcon();
    ...
    WeatherComponent.prototype.getLocationName = function () {
        ...
        this.service.getLocationName(this.pos.coords.latitude, this.pos.coords.longitude)
            ...
            _this.currentLocation = location["results"][1]["formatted_address"].slice(0, -5);
            console.log("Name: ", _this.currentLocation); //TODO: Remove after testing
        });
    };
