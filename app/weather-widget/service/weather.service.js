...
var WeatherService = (function () {
    ...
    WeatherService.prototype.getCurrentWeather = function (lat, lon) {
        var url = constants_1.FORECAST_ROOT + '/' + constants_1.FORECAST_KEY + "/" + lat + "," + lon;
    ...
    WeatherService.prototype.getLocationName = function (lat, lon) {
        var url = constants_1.GOOGLE_ROOT;
        var queryParams = "?latlng=" + lat + "," + lon + "&key=" + constants_1.GOOGLE_KEY;
